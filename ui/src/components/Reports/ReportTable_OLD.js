...
class ReportTable extends React.Component {
  ...
  render() {
    ...
    const { data, origem_primaria, origem_segundaria, destino_primario, destino_secundario, setor, aguardando_atendimento, duracao, status, sequencia, tipo, protocolo, tipo_saida, id, role } = call;
